...
function promptCategories() {
    ...
    console.log("hello world#$R%#!#%#%$#%!#$!$")
        ...
        // if statements with call back function inside
        // Adding Employee 
        if(answer.employee_tracker == "Add Employee"){
            addingEmployee();
        } 

        // if statements with call back function inside
        // Updating Employee Role
        if(answer.employee_tracker == "Update Employee Role"){
            updatingEmployee();
        } 

        // if statements with call back function inside
         // Updating Employee Manager
         if(answer.employee_tracker == "Update Employee's Manager"){
            updatingManager();
        } 

        // if statements with call back function inside
        // Deleting an employee
        if(answer.employee_tracker == "Delete An Employee"){
            deletingEmployee();
        } 

        // if statements with call back function inside
        // View employee by department
        if(answer.employee_tracker == "View Employee By Department"){
            viewingByDept();
        } 

        // if statements with call back function inside
        // Viewing all roles
        if(answer.employee_tracker == "View All Roles"){
            viewAllRoles();
        } 

        // if statements with call back function inside
        // Adding Roles
        if(answer.employee_tracker == "Add Role"){
        ...
        if(answer.employee_tracker == "Add Department"){
            addingDepartment();
        }

        // if statements with call back function inside
        // Completely exiting the program!
        if(answer.employee_tracker == "Exit"){
